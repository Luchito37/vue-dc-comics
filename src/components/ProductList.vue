<template>
    <div class="bg-dark py-4">
        ...
        <div class="container">
            ...
            <div class="col" v-for="prodotto in product" :key="prodotto.series">
                <ProductCard :card-title="prodotto.series" :img-url="prodotto.thumb"></ProductCard>
            </div>
        </div>
        <div class="col d-flex justify-content-center">
            <nav class="navbar">
                <form class="container-fluid justify-content-start">
                    <button class=" bg-primary me-2 text-white myBottom px-5" type="button">LOAD MORE</button>
                </form>
            </nav>
        </div>
        </div>
